...
musicBg_on.onclick = function() {
	musicBg_on.style.display = "block", musicBg_off.style.display = "none", bgm.src = "audio/bgm.m4a"
...
var NewsTime = 1e3,
	...
	newsi = 0,
	txti = 0,
	txttimer, newstimer, characterSayText = ["皇上今日咋还不上朝啊？", "莫不是溜出宫去玩了吧?", "我得速速寻他来，大臣们该怒了！"],
	page4_talk = ["这次微服私访民间甚是有趣，可惜时间有限不能一一尝试。", "朕有个想法，征集天下优秀数媒人才，让他们为国家发展出力", "征集成功者必有重赏！", "真好吃，小桂子，再去给朕爆20斤！"];
...
var mountainX = -472,
	...
	typeIndex = 0,
	typeTimer = null,
	firstTalk = ["这位师傅，这玉佩怎觉得似曾相识。", "这是我家大儿给我带回来", "您可否将这玉佩给我", "我方才正好有二两白银换取您的玉佩吧！", "我可做不了主，你要想得我这玉佩，得问我儿子", "打副【银镯】，再烧俩【掸瓶】来换吧！", "谢~~"],
	secondTalk = ["师傅，一副【银镯】，加急！", "有多着急，先回答我个问题呗~", "你太笨了，我才不给你打，再猜！", "客官真聪明，银镯奉上！"],
	secondTalk2 = ["掌柜的，来一对掸瓶。", "您知道掸瓶长啥样？", "您连掸瓶是啥都不知道吧，重选！", "呦，这位客官当真识货呀！"],
	secondTalk3 = ["齐活了，这下可以把【玉佩】给我了吧？", "恩，小伙子前途无量，玉佩就给你！"],
	canClick_lBtn = !0,
	canClick_rBtn = !0,
	canCllck_gBtn = !0,
	canClick_lBtn2 = !0,
	...
	canClick_rBtn4 = !0,
	canCllck_gBtn4 = !0,
	thirdTalk = ["万岁爷，可找到您了。", "您今天这装扮还真是…魅力无限啊！", "咱们快回去吧，大臣还等着觐见哪！", "这位先生，汝何人也？", "万岁你可别装了！要怎样您才肯回去呀！", "我想吃【爆米花】~", "晕！", "皇天在上，朕若负你，妄为一国之君", "你若负朕，不知道这上苍会怎么对你！", "果然不能得得罪心机男！ 哼哼哼"],
	thirdTalk2 = ["师傅，来2斤爆米花！", "好，让先测测您的“安全指数”！", "老爷，这是您要的二斤爆米花", "老爷你想被走啊，我得跑远点！"],
	fourthTalk = ["爷，这下可以回了吧！", "很好！待朕回宫慢慢品尝~"];